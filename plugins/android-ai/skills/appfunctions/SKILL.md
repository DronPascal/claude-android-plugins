...
name: appfunctions
description: >
  This skill should be used when the user asks to "expose the app to AI
  agents", "implement AppFunctions", "add app shortcuts for the
  assistant", "discover AppFunctions in the app", "register an app
  function", or mentions the AppFunctions framework, Android 16 agentic
  integration, or KSP AppFunction annotations.
upstream:
