...
name: adaptive
description: >
  This skill should be used when the user asks to "make the app adaptive",
  "support tablets and foldables", "add a navigation rail", "build a
  multi-pane layout", "responsive layout for large screens", or mentions
  NavigationSuiteScaffold, adaptive navigation, or window size classes.
upstream:
