...
name: compose-styles
description: >
  This skill should be used when the user asks to "add Compose styles",
  "use the Style API in Compose", "create reusable component styles",
  "share styling without a Modifier", or mentions the experimental
  androidx.compose.foundation.style.Style API,
  ExperimentalFoundationStyleApi, or animated style transitions.
upstream:
