...
name: verified-email
description: >
  This skill should be used when the user asks to "verify email with
  Credential Manager", "add cryptographic email verification", "implement
  Digital Credentials", "skip manual email verification on signup", or
  mentions GetDigitalCredentialOption, the Digital Credentials API,
  OpenID4VP, SD-JWT, or CredentialManager.
upstream:
