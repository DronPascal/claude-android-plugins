...
description: >
  This skill should be used when the user asks to "migrate to CameraX",
  "replace the Camera1 API", "migrate android.hardware.Camera", "upgrade
  camera code to CameraX", or mentions ProcessCameraProvider,
  CameraSelector, ImageCapture, PreviewView, or camera-compose.
upstream:
  source: android/skills
  path: camera/camera1-to-camerax
