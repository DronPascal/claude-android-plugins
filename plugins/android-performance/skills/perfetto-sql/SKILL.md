...
name: perfetto-sql
description: >
  This skill should be used when the user asks to "write a PerfettoSQL
  query", "query a Perfetto trace with SQL", "create a Perfetto table",
  "run a trace_processor query", or mentions trace_processor, SPAN_JOIN,
  PerfettoSQL, utid/upid, or EXTRACT_ARG.
upstream:
