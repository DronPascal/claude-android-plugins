...
description: >
  This skill should be used when the user asks to "integrate the Engage
  SDK", "publish content to Google surfaces", "add Play Engage", "set up
  an EngageWorker", "build content clusters for Google Discovery", or
  mentions AppEngageClient, EngageBroadcastReceiver, engage-core, or
  recommendation/continuation clusters.
upstream:
