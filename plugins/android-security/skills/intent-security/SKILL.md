...
description: >
  This skill should be used when the user asks to "secure Android
  intents", "fix an intent redirection vulnerability", "audit exported
  components", "secure a PendingIntent", "harden AndroidManifest
  security", or mentions IntentSanitizer, android:exported,
  PendingIntent.FLAG_IMMUTABLE, or RECEIVER_NOT_EXPORTED.
upstream:
