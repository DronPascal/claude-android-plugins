...
name: testing-setup
description: >
  This skill should be used when the user asks to "set up Android
  testing", "configure the test stack", "add testing dependencies", "set
  up Hilt for tests", "add screenshot testing", "configure Robolectric",
  or mentions Roborazzi, Dropshots, Compose Preview Screenshot Testing, or
  unit/UI/E2E test setup.
upstream:
