---
name: display-glasses-glimmer
description: >
  This skill should be used when the user asks to "build UI for display
  glasses", "add a Glimmer UI", "create a projected activity for glasses",
  "develop for Android XR glasses", or mentions Jetpack Compose Glimmer,
  GlimmerTheme, ProjectedContext, or androidx.xr.glimmer.
upstream:
